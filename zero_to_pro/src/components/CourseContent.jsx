    ...
    return (
      <div className="course-page">
        <div className="locked-overlay" style={{ marginTop: '60px' }}>
          ...
          <p className="locked-sub">Ce cours est en cours de rédaction. Revenez bientôt !</p>
        </div>
      </div>
    )
  }
    ...
    <div className="course-page">
      ...
      <div className="course-breadcrumb">
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', gap: '4px' }}>
          {courses.filter(c => c.content?.length > 0).map(c => {
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '48px', paddingTop: '24px', borderTop: '1px solid var(--border-1)' }}>
        ...
        <div>
          {nextCourse && nextCourse.content?.length > 0 && (
